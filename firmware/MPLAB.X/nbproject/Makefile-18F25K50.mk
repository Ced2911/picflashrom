...
SOURCEFILES_QUOTED_IF_SPACED=../src/system_config/pic18f25K50/system.c ../src/main.c ../src/mcp23s17.c ../src/command.c ../src/mcp23008/mcp23008.c ../src/spi.c ../src/app_usb.c ../src/rom.c ../framework/usb/src/usb_device_generic.c ../framework/usb/src/usb_device.c ../src/vendor/usb_descriptors.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/407776489/system.p1 ${OBJECTDIR}/_ext/1360937237/main.p1 ${OBJECTDIR}/_ext/1360937237/mcp23s17.p1 ${OBJECTDIR}/_ext/1360937237/command.p1 ${OBJECTDIR}/_ext/1792135863/mcp23008.p1 ${OBJECTDIR}/_ext/1360937237/spi.p1 ${OBJECTDIR}/_ext/1360937237/app_usb.p1 ${OBJECTDIR}/_ext/1360937237/rom.p1 ${OBJECTDIR}/_ext/2142726457/usb_device_generic.p1 ${OBJECTDIR}/_ext/2142726457/usb_device.p1 ${OBJECTDIR}/_ext/140694402/usb_descriptors.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/407776489/system.p1.d ${OBJECTDIR}/_ext/1360937237/main.p1.d ${OBJECTDIR}/_ext/1360937237/mcp23s17.p1.d ${OBJECTDIR}/_ext/1360937237/command.p1.d ${OBJECTDIR}/_ext/1792135863/mcp23008.p1.d ${OBJECTDIR}/_ext/1360937237/spi.p1.d ${OBJECTDIR}/_ext/1360937237/app_usb.p1.d ${OBJECTDIR}/_ext/1360937237/rom.p1.d ${OBJECTDIR}/_ext/2142726457/usb_device_generic.p1.d ${OBJECTDIR}/_ext/2142726457/usb_device.p1.d ${OBJECTDIR}/_ext/140694402/usb_descriptors.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/407776489/system.p1 ${OBJECTDIR}/_ext/1360937237/main.p1 ${OBJECTDIR}/_ext/1360937237/mcp23s17.p1 ${OBJECTDIR}/_ext/1360937237/command.p1 ${OBJECTDIR}/_ext/1792135863/mcp23008.p1 ${OBJECTDIR}/_ext/1360937237/spi.p1 ${OBJECTDIR}/_ext/1360937237/app_usb.p1 ${OBJECTDIR}/_ext/1360937237/rom.p1 ${OBJECTDIR}/_ext/2142726457/usb_device_generic.p1 ${OBJECTDIR}/_ext/2142726457/usb_device.p1 ${OBJECTDIR}/_ext/140694402/usb_descriptors.p1

# Source Files
SOURCEFILES=../src/system_config/pic18f25K50/system.c ../src/main.c ../src/mcp23s17.c ../src/command.c ../src/mcp23008/mcp23008.c ../src/spi.c ../src/app_usb.c ../src/rom.c ../framework/usb/src/usb_device_generic.c ../framework/usb/src/usb_device.c ../src/vendor/usb_descriptors.c
...
${OBJECTDIR}/_ext/1792135863/mcp23008.p1: ../src/mcp23008/mcp23008.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1792135863" 
	@${RM} ${OBJECTDIR}/_ext/1792135863/mcp23008.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1792135863/mcp23008.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --rom=default,-0-FFF,-1006-1007,-1016-1017 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 -I"../src" -I"../bsp/pic18F25K50" -I"../src/system_config/pic18F25K50" -I"C:/Program Files (x86)/Microchip/xc8/v1.37/include/plib" -I"../framework/usb/inc" -I"../src/vendor" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=0x1000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1792135863/mcp23008.p1  ../src/mcp23008/mcp23008.c 
	@-${MV} ${OBJECTDIR}/_ext/1792135863/mcp23008.d ${OBJECTDIR}/_ext/1792135863/mcp23008.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1792135863/mcp23008.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
